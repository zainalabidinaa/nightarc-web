      ...
      <div className="relative w-full max-w-sm mx-4 p-8 glass rounded-3xl shadow-2xl shadow-black/50">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <input type="email" placeholder="Email" value={email} onChange={e => setEmail(e.target.value)}
            className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-luna-muted focus:outline-none focus:border-purple-400/60 transition-all text-sm"
            required />
          ...
          {isSignUp && (
            <input type="text" placeholder="Invite Code" value={inviteCode}
              ...
              className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-luna-muted focus:outline-none focus:border-purple-400/60 transition-all text-sm uppercase tracking-widest"
              maxLength={8} />
          )}
          {error && (
