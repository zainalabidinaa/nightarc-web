...
public final class StreamAutoplayPreferenceStore {
    ...
    private let modePrefix = "moonlit.streamAutoplay.mode"
    private let automaticAddonUrlsPrefix = "moonlit.streamAutoplay.automaticAddonUrls"
    private let timeoutSecondsPrefix = "moonlit.streamAutoplay.timeoutSeconds"
